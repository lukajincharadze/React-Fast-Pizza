...
function Button({ children, disabled, to }) {
  // const className =
  //   'inline-block rounded-full bg-yellow-400 px-4 py-3 font-semibold uppercase tracking-wide text-stone-800 ring-yellow-300 ring-offset-2 transition-colors duration-300 hover:bg-yellow-300 focus:bg-yellow-300 focus:outline-none focus:ring disabled:cursor-not-allowed sm:px-6 sm:py-4';
  const className =
